...
export default function LandingPage() {
  ...
  // ─────────────────────────────────────────────────────────────
  // 2. SPLIDE CAROUSEL (restored original behavior)
  // ─────────────────────────────────────────────────────────────
  useEffect(() => {
    let splide = null
    ...
    async function initSplide() {
      ...
      splide = new Splide('.editorial-carousel', {
        ...
        perMove: 1,
        gap: '1rem',
        arrows: false,       // we use custom buttons for better control
        pagination: true,    // show dots (styled like original)
        speed: 800,
        drag: true,
        autoplay: true,
        interval: 5500,
  ...
  // ─────────────────────────────────────────────────────────────
  // 3. Data loading helpers (unchanged)
  // ─────────────────────────────────────────────────────────────
  ...
  const rosterForSelectedWeek = rosterMap[`${selectedMonth}-${selectedWeek}`]
  ...
  return (
    <div className="bg-[#f6f1ea] text-[#1e1e1e] overflow-x-hidden">
      ...
      >
        ...
        >
          <div className="h-[74px] px-4 md:px-6 flex items-center justify-between">
            <img src="/logo.webp" alt="GBT" className="h-10 w-auto object-contain" />
            ...
            {NAV_LINKS.map((item, i) =>
              item.isRouterLink ? (
                <button
                  ...
                  className={`block w-full text-center text-[clamp(2rem,8vw,5rem)] leading-none mb-4 font-['Lora'] text-white transition-all duration-500 ${
                ...
                <a
                  ...
                  style={{ transitionDelay: `${i * 60}ms` }}
                  className={`block text-[clamp(2rem,8vw,5rem)] leading-none mb-4 font-['Lora'] text-white transition-all duration-500 ${
                    menuOpen ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                  }`}
                >
                  {getNavText(item)}
      ...
      {/* ========== HERO SECTION (with RESTORED CAROUSEL BEHAVIOR) ========== */}
      <section id="home" className="relative min-h-screen overflow-hidden px-5 pt-[120px] pb-10">
        {/* Background layers */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-10 items-end min-h-[75vh]">
            {/* LEFT COLUMN (title, verse, buttons) */}
            <div>
              ...
              <h1 className="text-[clamp(3rem,12vw,9rem)] leading-[0.92] tracking-[-0.06em] text-[#171717] font-['Lora'] max-w-[11ch]">
                A house
                <br />
                for grace,
                <br />
            ...
            {/* RIGHT COLUMN – CAROUSEL (RESTORED SPLIDE WITH ORIGINAL BEHAVIOR) */}
            {carouselItems.length > 0 && (
              <div className="relative">
                <div className="rounded-[2.5rem] bg-[#1f1f1f] text-white p-5 md:p-8 shadow-[0_30px_90px_rgba(0,0,0,0.18)] border border-white/5">
                  {/* Header with label and custom arrows */}
                  ...
                  {/* Splide Carousel */}
                  <div className="editorial-carousel splide" aria-label="Announcements">
                    <div className="splide__track">
                      <ul className="splide__list">
                        {carouselItems.map((item) => (
                          <li key={item.id} className="splide__slide">
                            <div className="min-h-[360px] md:min-h-[380px] flex flex-col justify-between">
                              <div>
                                ...
                                <h3 className="mt-6 text-[clamp(1.8rem,4vw,3rem)] leading-[1.04] tracking-[-0.04em] font-['Lora'] max-w-[11ch]">
                                  {locale === 'bm' && item.title_bm ? item.title_bm : item.title_en}
                                </h3>

                                <p className="mt-6 text-[15px] leading-7 text-white/70 font-['DM_Sans'] max-w-[42ch]">
                  ...
                  {/* Floating bottom info (service time) */}
                  <div className="mt-8 rounded-[2rem] bg-white/6 border border-white/10 backdrop-blur-md p-5 flex items-center justify-between gap-5 flex-wrap">
                    <div>
                      <p className="uppercase tracking-[0.24em] text-[10px] text-[#c8a57f] mb-2 font-medium font-['DM_Sans']">
                        Sunday Worship
                      </p>
                      <h4 className="text-[1.2rem] font-['Lora']">9:00 AM — Main Sanctuary</h4>
                    </div>
          ...
          {/* Marquee ticker (mobile friendly) */}
          <div className="mt-14">
      ...
      {/* ========== ABOUT SECTION ========== */}
      <section id="about" className="relative px-5 pb-24 md:pb-36">
        <div className="max-w-7xl mx-auto">
          <div className="rounded-[3rem] bg-[#1d1d1d] overflow-hidden relative">
            ...
            <div className="relative z-10 grid lg:grid-cols-2 gap-12 p-8 md:p-16 lg:p-20">
              <div>
                <p className="uppercase tracking-[0.28em] text-[10px] text-[#c8a57f] mb-5 font-medium font-['DM_Sans']">
                  About Us
                </p>
                <h2 className="text-white text-[clamp(2rem,6vw,5rem)] leading-[0.96] tracking-[-0.05em] font-['Lora'] max-w-[9ch]">
                  Building
                  <br />
                  people
                  <br />
                ...
                <div className="mt-14 grid sm:grid-cols-2 gap-5">
                  <div className="rounded-[2rem] bg-white/6 border border-white/10 p-6">
                    ...
                    <p className="text-white/75 leading-7 font-['DM_Sans']">
                      Christ-centred gatherings rooted in scripture, prayer and worship.
                    </p>
                  </div>
                  <div className="rounded-[2rem] bg-white/6 border border-white/10 p-6">
                    <p className="uppercase tracking-[0.22em] text-[10px] text-[#c8a57f] mb-4 font-medium font-['DM_Sans']">
                    ...
                    <p className="text-white/75 leading-7 font-['DM_Sans']">
                      A church family growing together through discipleship and fellowship.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <footer className="px-5 pb-8">
        <div className="max-w-7xl mx-auto rounded-[2.5rem] bg-white border border-black/5 px-6 py-10 md:px-8">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-10">
            <div>
              <p className="uppercase tracking-[0.28em] text-[10px] text-[#9f8466] mb-4 font-medium font-['DM_Sans']">
                Grace Bible Church Tawau
              </p>
              <h3 className="text-[clamp(1.8rem,5vw,4rem)] leading-[1] tracking-[-0.05em] font-['Lora'] max-w-[10ch]">
                A place to belong.
              </h3>
            </div>
      ...
      {/* ========== EVENTS MODAL (unchanged, already mobile friendly) ========== */}
      {isEventsModalOpen && (
        <div className="fixed inset-0 z-[70] p-4 bg-black/50 backdrop-blur-xl flex items-center justify-center">
          <div className="w-full max-w-3xl bg-[#f6f1ea] rounded-[2rem] overflow-hidden shadow-[0_40px_120px_rgba(0,0,0,0.25)]">
            <div className="flex items-center justify-between px-5 py-5 md:px-7 md:py-6 border-b border-black/5">
              <h2 className="text-[1.5rem] md:text-[1.7rem] font-['Lora']">
            ...
            <div className="max-h-[70vh] overflow-y-auto p-5 md:p-7">
              {!selectedEvent ? (
                  ...
                  {events.map((event) => {
                    ...
                    return (
                      <button
                        ...
                        className="w-full rounded-[1.8rem] bg-white border border-black/5 p-4 md:p-5 flex items-center justify-between gap-4 hover:-translate-y-[2px] transition"
                      >
                        <div className="flex items-center gap-4 text-left">
                          <div className="w-[70px] h-[70px] md:w-[76px] md:h-[76px] rounded-[1.5rem] bg-[#1f1f1f] text-white flex flex-col items-center justify-center shrink-0">
                            <span className="text-[1.4rem] md:text-[1.6rem] leading-none font-['Lora']">
                              {formatted.day}
                            </span>
                            <span className="uppercase tracking-[0.18em] text-[9px] text-white/60 mt-1 font-['DM_Sans']">
                              {formatted.month}
                            </span>
                          </div>
                          <div>
                            <h3 className="text-[1.1rem] md:text-[1.25rem] font-['Lora']">
                              {locale === 'bm' && event.title_bm ? event.title_bm : event.title_en}
                            </h3>
                            <p className="mt-1 text-[#7b6d61] text-xs md:text-sm font-['DM_Sans']">
                              {formatted.weekday} · {formatTimeForDisplay(event.time)}
                            </p>
                          </div>
                        </div>
                ...
                <div>
                  ...
                  <div className="rounded-[2rem] bg-white border border-black/5 p-6 md:p-7">
                    <h3 className="text-[1.8rem] md:text-[2rem] leading-tight font-['Lora']">
                      {locale === 'bm' && selectedEvent.title_bm
                        ? selectedEvent.title_bm
                        : selectedEvent.title_en}
                    </h3>
                    <div className="mt-6 space-y-4 text-[#5f554d] font-['DM_Sans']">
      ...
      {isRosterModalOpen && (
        <div className="fixed inset-0 z-[70] p-4 bg-black/50 backdrop-blur-xl flex items-center justify-center">
          <div className="w-full max-w-2xl bg-[#f6f1ea] rounded-[2rem] overflow-hidden shadow-[0_40px_120px_rgba(0,0,0,0.25)]">
            <div className="flex items-center justify-between px-5 py-5 md:px-7 md:py-6 border-b border-black/5">
              <h2 className="text-[1.5rem] md:text-[1.7rem] font-['Lora']">{t('roster_modal_title')}</h2>
              <button
            ...
            <div className="p-5 md:p-7">
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <ChevronDown size={18} className="absolute right-5 top-1/2 -translate-y-1/2 pointer-events-none" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 gap-2 md:gap-3 mb-7">
                {[1, 2, 3, 4].map((week) => (
                  <button
                    ...
                    className={`h-[48px] md:h-[52px] rounded-full text-sm transition font-medium font-['DM_Sans'] ${
                      selectedWeek === week ? 'bg-[#1f1f1f] text-white' : 'bg-white border border-black/5'
                    }`}
                  >
                    Week {week}
                  </button>
              ...
              <div className="rounded-[2rem] bg-white border border-black/5 p-5 md:p-6">
                {rosterForSelectedWeek ? (
                  <div className="space-y-5">
                    <div>
                      ...
                      <h3 className="text-[1.3rem] md:text-[1.5rem] font-['Lora']">
                  ...
                  <p className="text-[#7a7067] font-['DM_Sans']">{t('roster_no_data')}</p>
                )}
              </div>
            </div>
          </div>
      ...
      {/* ========== GLOBAL STYLES (including marquee & splide pagination) ========== */}
      <style>{`
        html {
        ...
        * {
        ...
        /* Splide pagination – original style (elongated active dot) */
        .splide__pagination {
        ...
        /* Marquee animation – mobile speed reduced */
        .marquee-wrap {
          overflow: hidden;
          width: 100%;
          padding: 1rem 0;
